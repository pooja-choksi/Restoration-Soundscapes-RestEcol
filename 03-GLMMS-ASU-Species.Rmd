...
asu = read.csv("C:\\Users\\pooja\\Documents\\GitHub\\Restoration-Soundscapes-RestEcol\\Winter2020-2021-ASU-Prop.csv")
...
#First create a dataframe of the ASU and the predictor variables 
#ASU between 2 to 8k Hz
asu_low = asu%>%filter(Frequency_128> 10 & Frequency_128< 44)

#drop AO_3
to_remove = asu_low%>%filter(Site_Code == "AO_3")
asu_low = anti_join(asu_low, to_remove)

year2020 = asu_low%>%filter(Season== "Winter_2020")
year2020_AO = year2020%>%filter(Site_Code == c("AO_1", "AO_2"))
asu_low = anti_join(asu_low, year2020_AO)
